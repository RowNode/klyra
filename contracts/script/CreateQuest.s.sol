 ...
 *
 * Usage:
 *   forge script script/CreateQuest.s.sol:CreateQuest --rpc-url mantle-sepolia --broadcast
 *
 ...
 *   - REWARD_PER_PARTICIPANT: Reward dalam KLYRA token (with 18 decimals, standard ERC-20)
