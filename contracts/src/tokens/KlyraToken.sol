...
/**
 * @title KlyraToken
 * @notice ERC-20 token for Klyra DeFi Quest rewards.
 *         Mintable by RewardVault contract for distributing quest rewards.
 */
contract KlyraToken is ERC20, ERC20Burnable, AccessControl {
    ...
    constructor(address owner) ERC20("Klyra Token", "KLYRA") {
