...
// Note: For proper testing, we'll use actual contracts
...
contract QuestManagerTest is Test {
    ...
    function setUp() public {
        ...
        // Deploy KlyraToken (ERC-20) for testing
        KlyraToken klyraToken = new KlyraToken(owner);
    ...
    function test_CreateQuest_RevertIf_NoKlyraToken() public {
        // Create new vault without klyra token set
        ...
        // Will revert because klyraToken is not set in RewardVault
